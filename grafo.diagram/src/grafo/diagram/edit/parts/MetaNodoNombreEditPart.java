...
import grafo.diagram.edit.policies.GrafoTextSelectionEditPolicy;
 ...
 * @generated
 */
public class MetaNodoNombreEditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public MetaNodoNombreEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicy.SELECTION_FEEDBACK_ROLE,
				new GrafoTextSelectionEditPolicy());
	...
	protected Image getLabelIcon() {
		...
		return GrafoElementTypes.getImage(parserElement.eClass());
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = GrafoParserProvider
					.getParser(
							GrafoElementTypes.MetaNodo_2002,
							getParserElement(),
							GrafoVisualIDRegistry
									.getType(grafo.diagram.edit.parts.MetaNodoNombreEditPart.VISUAL_ID));
		}
		return parser;
	}
	...
	protected DirectEditManager getManager() {
		if (manager == null) {
			setManager(new TextDirectEditManager2(this, null,
					GrafoEditPartFactory.getTextCellEditorLocator(this)));
		}
		return manager;
	}
